        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <Button variant="ghost" size="icon" className="text-warm-gray-400 hover:text-white hover:bg-warm-gray-800" aria-label="Facebook">
                <Facebook className="h-5 w-5" />
              </Button>
              <Button variant="ghost" size="icon" className="text-warm-gray-400 hover:text-white hover:bg-warm-gray-800" aria-label="Twitter">
                <Twitter className="h-5 w-5" />
              </Button>
              <Button variant="ghost" size="icon" className="text-warm-gray-400 hover:text-white hover:bg-warm-gray-800" aria-label="Instagram">
                <Instagram className="h-5 w-5" />
              </Button>
              <Button variant="ghost" size="icon" className="text-warm-gray-400 hover:text-white hover:bg-warm-gray-800" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Buy Properties", "Rent Properties", "Sell Your Home", "Property Management", "Market Insights"].map((link) => (
                <li key={link}>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  className="bg-warm-gray-800 border-warm-gray-700 text-blue placeholder:green"
                  type="email"
          ...
          <div className="flex items-center gap-6 mt-4 md:mt-0">
            {["Privacy", "Terms", "Sitemap"].map((link) => (
              <a
                key={link}
                href="#"
                className="text-warm-gray-400 hover:text-white text-sm transition-colors"
              >
                {link}
              </a>
            ))}
